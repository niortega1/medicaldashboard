...
const initialState = {
    patients: [
        ...
        { id: 1, name: 'Carrie Darby',  age: 42, condition: 'Bronchitis', email: 'cdarby@email.com', phone: '(123) 456-7890', lastVisit: '2023-10-10', paymentStatus: 'Payment Pending'},
        { id: 1, name: 'Eddie Fox',  age: 65, condition: 'Chickenpox', email: 'efox@email.com', phone: '(123) 456-7890', lastVisit: '2023-10-10', paymentStatus: 'Paid'},
        { id: 1, name: 'Gary Harrison',  age: 53, condition: 'Diabetes', email: 'gharrison@email.com', phone: '(123) 456-7890', lastVisit: '2023-05-15', paymentStatus: 'Not Paid', stripeLink: "https://invoice.stripe.com/i/acct_1O9CL3JQsxU37Meb/test_YWNjdF8xTzlDTDNKUXN4VTM3TWViLF9PeENOUnk3VldYdWE3Rm5pNUhrUk1mRnA3MjJTcVljLDg5Nzc2NzA40200if7cM1In?s=db"},
        { id: 1, name: 'Isabelle Jefferson',  age: 18, condition: 'Endometriosis', email: 'ijefferson@email.com', phone: '(123) 456-7890', lastVisit: '2022-08-05', paymentStatus: 'Payment Pending'},
        { id: 1, name: 'Kyle Langford',  age: 34, condition: 'Fibromyalgia', email: 'klangford@email.com', phone: '(123) 456-7890', lastVisit: '2021-12-14', paymentStatus: 'Paid'},
        { id: 1, name: 'Mason Nord',  age: 28, condition: 'Gum disease', email: 'mnord@email.com', phone: '(123) 456-7890', lastVisit: '2023-04-13', paymentStatus: 'Paid'},
    ],
    status: null,
};
